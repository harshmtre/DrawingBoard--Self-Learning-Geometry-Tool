...
public class sphere extends Applet implements MouseListener,MouseMotionListener {
	...
	public sphere(float height)
	{
		this.height=height;
	      vol=4*3.14*Math.pow(height,3)/3;
           area=3.14*4*Math.pow(height, 2);
...
grp.addChild(txt2);
 ...
 // text2d3.setBoundsAutoCompute(true);
  ...
  un.addBranchGraph(grp);	
     ...
     {
    	Frame f3=new MainFrame(new sphere(),1350,1000); 
     }
	@Override
