...
public class cone extends Applet implements MouseListener,MouseMotionListener{
	...
	public cone(float radius,float height)
	{
		this.height=height;
		this.radius=radius;
          vol=3.14*Math.pow(radius,2)*height/3;
           area=3.14*radius*Math.sqrt((height*height)+(radius*radius));     
     ...
     public void init()
     {
		...
		Cone con1=new Cone(height,radius);
     ...
     {
    	Frame f1=new MainFrame(new cone(),1350,1000); 
     }
	@Override
